...
namespace Utils
{
    ...
    public static partial class Maths
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ClampAbs(this int a, int b) => a < -b ? -b : a > b ? b : a;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float ClampAbs(this float a, float b) => a < -b ? -b : a > b ? b : a;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Rect XMin(this Rect a, float v)
        {
            a.xMin = v;
            return a;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Rect XMax(this Rect a, float v)
        {
            a.xMax = v;
            return a;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Rect YMin(this Rect a, float v)
        {
            a.yMin = v;
            return a;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Rect YMax(this Rect a, float v)
        {
            a.yMax = v;
            return a;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color A(this Color a, float x) => new Color(a.r, a.g, a.b, x);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color R(this Color a, float x) => new Color(x, a.g, a.b, a.a);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color G(this Color a, float x) => new Color(a.r, x, a.b, a.a);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color B(this Color a, float x) => new Color(a.r, a.g, x, a.a);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Deconstruct(this Vector2 a, out float x, out float y) => (x, y) = (a.x, a.y);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Deconstruct(this Vector3 a, out float x, out float y, out float z) => (x, y, z) = (a.x, a.y, a.z);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Deconstruct(this Vector4 a, out float x, out float y, out float z, out float w) => (x, y, z, w) = (a.x, a.y, a.z, a.w);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Deconstruct(this Color x, out float r, out float g, out float b, out float a) => (r, g, b, a) = (x.r, x.g, x.b, x.a);
